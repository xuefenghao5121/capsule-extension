 ...
 */
export declare function executeL1(options: ExecutionOptions): Promise<IsolationResult>;
/**
 * L1+ 进程隔离 + cgroups 资源限制
 */
export declare function executeL1Plus(options: ExecutionOptions, config: IsolationConfig): Promise<IsolationResult>;
/**
 * L2 Docker 容器隔离
 */
export declare function executeL2(options: ExecutionOptions, config: IsolationConfig): Promise<IsolationResult>;
/**
 * L2+/L3 SGX Enclave 隔离
 */
export declare function executeSGX(options: ExecutionOptions, config: IsolationConfig): Promise<IsolationResult>;
/**
 * 统一的隔离执行接口
 */
export declare function executeIsolated(level: "L1" | "L1+" | "L2" | "L2+" | "L3", options: ExecutionOptions, config?: IsolationConfig): Promise<IsolationResult>;
/**
 * 检查并强制执行能力限制
 */
